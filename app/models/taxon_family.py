...
class TaxonFamily(db.Model, TaxonMixin):
    ...
    taxon = db.relationship("Taxon", back_populates="taxon_family", uselist=False, lazy="selectin")
    parent = db.relationship("TaxonOrder", back_populates="descendants", lazy="selectin")
