...
class TaxonKingdom(db.Model, TaxonMixin):
    ...
    taxon = db.relationship("Taxon", back_populates="taxon_kingdom", uselist=False, lazy="selectin")
    descendants = db.relationship("TaxonPhylum", back_populates="parent", lazy="selectin")
